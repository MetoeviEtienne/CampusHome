...
<h2 class="text-center text-3xl font-extrabold text-white mb-6">Créer un compte</h2>
    ...
    <div class="step hidden" id="step3">
        <div class="mb-4 relative">
            ...
            <input id="password" name="password" type="password" required autocomplete="new-password"
                class="block w-full px-4 py-3 text-lg border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 pr-10" />
            <button type="button" tabindex="-1" class="absolute top-9 right-3 text-gray-500 hover:text-indigo-600" onclick="togglePassword('password', this)">
        ...
        <div class="mb-6 relative">
            ...
            <input id="password_confirmation" name="password_confirmation" type="password" required autocomplete="new-password"
                class="block w-full px-4 py-3 text-lg border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 pr-10" />
            <button type="button" tabindex="-1" class="absolute top-9 right-3 text-gray-500 hover:text-indigo-600" onclick="togglePassword('password_confirmation', this)">
                <i class="fa-solid fa-eye"></i>
            </button>
