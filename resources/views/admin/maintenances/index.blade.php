...
<div class="max-w-6xl mx-auto p-6">
    <h2 class="text-2xl font-semibold mb-6">Tous les signalements de maintenance</h2>
            ...
            <tbody>
                @forelse($demandes as $demande)
                    <tr class="border-b hover:bg-gray-50">
                        ...
                        <td class="py-2">{{ $demande->logement->proprietaire->name ?? 'N/A' }}</td>
                ...
                @empty
                    <tr>
                        <td colspan="7" class="py-4 text-center text-gray-500">Aucun signalement trouvé.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
